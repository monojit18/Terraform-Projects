terraform {
  ...
  backend "azurerm" {
    ...
    access_key = "EQtIdxjjcmeKtnYK6ETBD8az+CyhgxpiUySH6Ad4PdRus/rVwV5A9/DTRygYKSnAszC6LybRL84caZ3fdNCNKg=="
  }
}
...
resource "azurerm_kubernetes_cluster" "terraksk8s" {
  ...
  # private_dns_zone_id = var.is_Private_cluster ? data.azurerm_private_dns_zone.aksapipvtdns.id : "None"
